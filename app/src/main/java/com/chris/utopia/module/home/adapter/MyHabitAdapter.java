...
public class MyHabitAdapter extends RecyclerView.Adapter<MyHabitAdapter.ViewHolder> {
    ...
    public MyHabitAdapter(Context context, List<Thing> dList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context).inflate(R.layout.listview_habit_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(StringUtil.isNotEmpty(thing.getWhatDay())) {
            holder.timeTv.setText(thing.getWhatDay() +"-"+ thing.getBeginTime());
        }else {
            holder.timeTv.setText(thing.getBeginTime());
        }
        holder.holdOnDayTv.setText(thing.getHoldOnDay() != null ? thing.getHoldOnDay()+"" : "0");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(Context context,final View itemView) {
            ...
            rootView = itemView.findViewById(R.id.habitLv_layout);
            holdOnDayTv = (TextView) itemView.findViewById(R.id.habitLv_day_tv);
            titleTv = (TextView) itemView.findViewById(R.id.habitLv_title_tv);
            timeTv = (TextView) itemView.findViewById(R.id.habitLv_time_tv);
            descTv = (TextView) itemView.findViewById(R.id.habitLv_desc_tv);
